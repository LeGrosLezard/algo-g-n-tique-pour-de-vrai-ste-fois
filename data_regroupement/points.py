...
for i in ok_liste:
    ...
    liste_pointsX = [x for x in range(gray.shape[0]) for y in range(gray.shape[1]) if gray[x, y] >= 200]
    liste_pointsY = [y for x in range(gray.shape[0]) for y in range(gray.shape[1]) if gray[x, y] >= 200]
    all_points = [[x, y] for x in range(gray.shape[0]) for y in range(gray.shape[1]) if gray[x, y] >= 200]
    ...
    try:
        ...
        ok_listoune.append((mini[0][0][1], mini[0][0][0], mini[0][1][1], mini[0][1][0]))
